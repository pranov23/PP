...
public class Rectangle implements Shape{
	...
	private static final String Error_CanvasNotCreated = "Canvas not created yet, first Create Canvas then try drawing the Rectangle \n";
	private static final String Error_InCorrectPoint = "Error ! Incorrect Point\n";
//	private static final String Error_InvalidRectangle = "Error ! A Rectangle cannot be drawn with the given Points\n";
...
//		if(x1!=x2&& y1!=y2){
//			System.out.println(Error_InvalidRectangle);
//			return ;
//		}
